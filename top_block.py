...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_rms_xx_0_1 = blocks.rms_ff(0.01)
        self.blocks_rms_xx_0 = blocks.rms_ff(0.01)
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1, 0)
        self.analog_fastnoise_source_x_1 = analog.fastnoise_source_f(analog.GR_GAUSSIAN, 1, -1, 8192)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_fastnoise_source_x_1, 0), (self.blocks_throttle_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_throttle_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_time_sink_x_1_1, 0))
        self.connect((self.blocks_rms_xx_0, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_rms_xx_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_rms_xx_0_1, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_rms_xx_0_1, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.blocks_rms_xx_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.qtgui_time_sink_x_1_0_0, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_rms_xx_0_1, 0))
        self.connect((self.blocks_throttle_1, 0), (self.qtgui_time_sink_x_1_0_0_0, 0))
